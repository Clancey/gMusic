...
namespace MusicPlayer.iOS
{
	public class Style
	{
		...
		public UIColor AccentColor => AccentSolidColor;//IsDeviceDark ? AccentSolidColor : AccentGradientColor;
													   //public UIColor AccentGradientColor { get; set; } = AccentSolidColor;//UIColor.FromPatternImage(UIImage.FromBundle("accentColor"));
													   //public UIColor AccentColorGradientHorizontal { get; set; } = AccentSolidColor;// UIColor.FromPatternImage(UIImage.FromBundle("accentColor").Rotate());
		public UIColor AccentColorHorizontal => AccentSolidColor;//IsDeviceDark ? AccentSolidColor : AccentColorGradientHorizontal;
